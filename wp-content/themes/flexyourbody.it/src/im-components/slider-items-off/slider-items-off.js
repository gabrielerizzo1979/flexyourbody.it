...
import './slider-items-off.scss';

// EXPORT COMPONENTE
const sliderItemsOff = () => {
    let allSliderItemsOff = document.querySelectorAll('.im-slider-items-off');

    if (!allSliderItemsOff.length) return;

    allSliderItemsOff.forEach((el, i) => {
